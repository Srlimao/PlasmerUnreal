...
protected:
/// <summary>
/// Internal callbacks to the delegates to add to the Online Session Interface delegate list
...
private:
	...
	// Need to bind the MultiplayerSessionsSubsystem internal callbacks to these
	//
